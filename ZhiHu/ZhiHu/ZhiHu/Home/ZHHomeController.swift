...
class ZHHomeController: ZHViewController {
    ...
    func initSearchBar() {
        let textField = UITextField(frame: CGRect(x: 10, y: statusBarHeight + 10, width: ScreenWidth - 80, height: barHeight))
        ...
        let questionBtn = UIButton(type: UIButtonType.system)
